...
17/10/2023
ASIXc1C M03 UF1
Descripció:Demana una paraula per teclat i mostrar-la per pantalla, canviar les vocals per als numèrics 1, 2, 3, 4 o 5.
Tenint en compte, que la lletra a i A és l'1, consecutivament fins a la lletra u i U que és el 5.
'''
#Canviar vocals tant minuscules com majuscules a valors numerics, sent a/A=1 i u/U=5
